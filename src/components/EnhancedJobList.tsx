    ...
    <div className="space-y-6 w-full">
      ...
      <div className="space-y-4 w-full">
        {jobs.map((job) => (
          <div
            key={job.id}
            className="bg-cssecondary p-4 sm:p-6 rounded-lg hover:ring-1 hover:ring-csgreen transition-all w-full overflow-hidden"
          >
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4 gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="text-xl font-semibold mb-2 text-white break-words">
                  {job.title}
                </h3>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {job.skills.slice(0, 6).map((skill, index) => (
                  <Badge
                    key={index}
                    variant="secondary"
                    className="bg-csgreen/20 text-csgreen text-xs"
                  >
                    {skill}
                  </Badge>
                ))}
