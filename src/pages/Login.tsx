...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden bg-gradient-to-br from-csdark via-cssecondary to-csdark">
        ...
        <div className="w-full lg:w-1/2 relative order-2 lg:order-1">
          ...
          <div className="absolute bottom-6 left-6 right-6 lg:bottom-8 lg:left-8 lg:right-8">
            <h2 className="text-2xl lg:text-3xl font-bold text-white mb-2">
              Welcome back to your CS journey
            </h2>
            <p className="text-gray-200 text-sm lg:text-base">
              Continue learning with personalized mentorship and cutting-edge courses.
            </p>
          </div>
        </div>
      ...
      <div className="absolute top-20 left-20 w-72 h-72 bg-csgreen/20 rounded-full blur-[120px] -z-10" />
      <div className="absolute bottom-20 right-20 w-72 h-72 bg-blue-400/20 rounded-full blur-[120px] -z-10" />
    </div>
  );
};
